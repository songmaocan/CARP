...
class ADMM:
    def __init__(self):
        #数据输入
        self.base_profit=0   #multipliers
        ...
        self.vehicle_arrival_time_ending=30
        self.big_M=50
        #ADMM
        self.ADMM_iteration_times=40
        self.rpo=2 #惩罚参数
...
# step2:找下界
            ...
            for vv in range(self.g_number_of_vehicles):
                self.ADMM_local_LB[i]+=self.g_ending_state_vector[self.g_number_of_vehicles].VSStateVector[1].Label_cost_for_lagrangian
